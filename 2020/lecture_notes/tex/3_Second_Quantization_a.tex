...
%go through lemma 1 and 2 (maybe after anticommutation relations b/c need those? , also, see property 2 
%distinguish determinant form vs ON form
%determinant can be directly represented without phase ambiguity 
%why spend so much time on ON if don't really use it? 
% from here on mostly just work with determinant representation 
